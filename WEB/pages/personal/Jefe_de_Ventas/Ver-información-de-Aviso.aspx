<%@ Page Title="" Language="C#" MasterPageFile="~/pages/MasterPagePanel.master" AutoEventWireup="true" CodeFile="Ver-información-de-Aviso.aspx.cs" Inherits="pages_personal_Jefe_de_Ventas_Ver_información_de_Aviso" %>
          ...
          <div class="modal-dialog" style="width:28% !important">
                    <div class="modal-content">
                        ...
                        <div class="caja-loguin">
                             <span class="cabecera-loguin-entrar" style="color:green">MiHogar-Perú
                            </span>
                         ...
                         <asp:Label ID="lblMensaje" runat="server" CssClass="texto-publicacion-venta" Text="Mensaje:"></asp:Label>  
                          ...
                          <div>
                         <span  class="help-block"></span>
                     <asp:TextBox ID="txtRechazo" runat="server" Class="form-control" style="height:200px;" TextMode="MultiLine"></asp:TextBox>
                         </div>
      </div>
                        </div>
