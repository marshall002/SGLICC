...
public partial class MasterPagePanel : System.Web.UI.MasterPage
{
        ...
        string html = string.Format(@"                 
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                         <a class='nav-link nav-link-collapse collapsed' data-toggle='collapse' href ='#collapseComponents0' data-parent='#exampleAccordion'>
                            <i class='material-icons'>content_paste</i><span class='nav-link-text'> Clientes</span>
                        </a>
                     ...
                     <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                         <a class='nav-link nav-link-collapse collapsed' data-toggle='collapse' href ='#collapseComponents1' data-parent='#exampleAccordion'>
                            <i class='material-icons'>assignment_ind</i><span class='nav-link-text'> Personal</span>
                        </a>
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                         <a class='nav-link nav-link-collapse collapsed' data-toggle='collapse' href ='#collapseComponents2' data-parent='#exampleAccordion'>
                            <i class='material-icons'>account_balance</i><span class='nav-link-text'>Reporte de Ventas</span>                           
                        </a>
                        <ul class='sidenav - second - level collapse' id='collapseComponents2'>
                            <li>
                                <a class='nav-link' href='#' onclick='modal('modalEnConstruccion');'> Gestionar Sedes</a>
                            </li>
                            <li>
                                <a class='nav-link' href='#' onclick='modal('modalEnConstruccion');'> Reportes</a>
                            </li>
                        </ul>
                    </li>
                   ...
                   <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                         <a class='nav-link nav-link-collapse collapsed' data-toggle='collapse' href ='#GestionarVentas' data-parent='#exampleAccordion'>
                            <i class='material-icons'>accessibility</i><span class='nav-link-text'> Gestionar Avisos de Inmuebles</span>
                        </a>
                   ...
                   <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                    ...
                    <li class='nav-item' data-toggle='tooltip' data-placement='right' title='Components'>
                        ...
                        <ul class='sidenav - second - level collapse' id='Actividad'>
                            ...
                            <li>
                                <a class='nav-link' href='/pages/cliente/propietario/propietario.aspx?idtipo=1'> Supervisar Compras de Inmueble</a>
                            </li>                            
                        </ul>
                    </li>
    ...
    public void perfil_proveedor()
    {
        ...
        string html = string.Format(@"
                    <li>
                        <a href='realizar-matricula.aspx'>
                            <i class='material-icons'>assignment_turned_in</i>
                            <span>Matr&iacute;cula</span>
                        </a>
                        <a href='VerPrograma.aspx'>
                            <i class='material-icons'>assignment_turned_in</i>
                            <span>Ver programa</span>
                        </a>
                    </li>
                    <li>
                        <a href='pagar-compromiso.aspx'>
                            <i class='material-icons'>attach_money</i>
                            <span>Mis compromisos de pago</span>
                        </a>
                    </li>
                    <li>
                        <a href='#'>
